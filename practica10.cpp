...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	//kit.VertexNormals();//jala los vectores normales, para la luz, puede que el modelo los tenga,puede que no
	...
	glPushMatrix();
		...
		glPushMatrix();		
			...
			glPushMatrix();
				...
				glRotatef(llantarotada, 1, 0, 0);//rotacion llanta
