...
void display(void)   // Creamos la funcion donde se dibuja
{
	...
	glPopMatrix();
		...
		glPushMatrix();
		glTranslatef(0, 0, 0);
		fig1.cilindro(0.5, 2, 12, madera.GLindex);
		glPopMatrix();
		
		glPushMatrix();
		glTranslatef(0, 2, 0);
		fig1.cono(2, 2, 12, pino.GLindex);
		glPopMatrix();

		glPushMatrix();
		glTranslatef(0, 3, 0);
		fig1.cono(2, 1.5, 12, pino.GLindex);
		glPopMatrix();

		glPushMatrix();
		glTranslatef(0, 4, 0);
		fig1.cono(2, 1, 12, pino.GLindex);
		glPopMatrix();

		glPushMatrix();
		glTranslatef(1.0, 4, 0);
		fig1.esfera(0.2, 15, 15, azul.GLindex);
		glPopMatrix();


		glPushMatrix();
		glTranslatef(0.8, 0.5, 0);
		fig1.prisma(0.5, 0.5, 0.5, azul.GLindex);
		glPopMatrix();
